...
Una vez publicada una denuncia en Nostr, los operadores de las Meta-Islas o los Sponsors verificados (utilizando su token SponsorAccount) radican la denuncia en el Banco de Acusaciones del Tribunal de Arbitraje. Al hacerlo, obtienen un token numérico que representa la denuncia interpuesta. 
